...
public class ProductService {
    ...
    public List<Product> getAllProducts() {
        return dataEngine.getProductRepository().findAllProducts();
    }
    ...
    private JsonObjectBuilder itemsWithHeading(String heading) {
        ...
        dataEngine.getProductRepository().findAllFeaturedProducts().forEach(product -> {
    ...
    public Response getProductById(@PathParam("id") int productId, @Context HttpHeaders headers) {
        ...
        Product product = dataEngine.getProductRepository().findProductById(productId);
